...
class User(BaseModel):
    ...
    approved_by: Optional[str] = Field(
        default=None,
        description="Username of the admin who approved the account"
    )
...
class AdminApprovalRequest(BaseModel):
    ...
    username: str = Field(
        ...,
        description="Username of the user to approve/reject"
    )
    action: str = Field(
        ...,
...
class PendingUserInfo(BaseModel):
    ...
    username: str = Field(
        description="Username of the pending user"
    )
    email: str = Field(
        description="Email address of the pending user"
    )
    created_at: datetime = Field(
